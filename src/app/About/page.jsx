    ...
    <div className="about-page" ref={containerRef}>
        ...
        <div className="history-container">
          ...
          <div className="history-content">
            ...
            <p className="history-description">
              Founded in 2009, Sai Saranya Enterprises is a trusted name in
              construction materials supply based in Kundrathur, Chennai. For
              over a decade, we have been supplying Fly Ash Bricks, Solid
              Blocks, Paver Blocks, M-Sand, P-Sand, and Crusher Dust to
              residential and commercial projects across Kanchipuram,
              Poonamallee, Mangadu, and Porur. Our goal is simple — to provide
              top-quality materials, timely delivery, and transparent pricing
            </p>
      ...
      <section ref={workRef} id="commitment" className="work-section section-3">
        ...
        <p className="work-description">
          At Sai Saranya Enterprises, every order—big or small—matters equally.
          We are committed to providing honest pricing, prompt communication,
          and lasting quality, ensuring that every client builds with confidence
          and satisfaction.
        </p>
